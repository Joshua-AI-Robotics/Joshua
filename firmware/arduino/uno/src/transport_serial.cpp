...
void TransportInit(void) {
  // Uno R3 UART baud is real (ATmega16U2 or CH340 USB-serial). Must match
  // Board.comm.serial_config.baudrate on the host (115200 in the example
  // preset). Unlike Teensy native USB CDC, this is not ignored.
  Serial.begin(115200);
