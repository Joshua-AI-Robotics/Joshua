// firmware/arduino/uno/src/channel_table.c — declares how many STEP_DIR
// channel slots this firmware image exposes (docs/BOARD_LAYER_RFC.md
// §7.4). This variant: one channel slot. Uno SRAM is 2KB; keep the table
// small.
//
...
// (config/config_preset/example/arduino_stepper_demo.pbtxt) for the pin
