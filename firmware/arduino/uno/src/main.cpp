// firmware/arduino/uno — Joshua's own firmware protocol (joshua_wire_v1) on
// an Arduino Uno R3 (ATmega328P), driving TB6600 (or any STEP/DIR drive)
// channels declared in channel_table.c (docs/BOARD_LAYER_RFC.md §7). No
// joint names, no limits, no robot identity here — this binary is "N
// STEP_DIR channels speaking joshua_wire_v1", nothing else; per-robot
// facts live in the host .pbtxt.
#include <Arduino.h>
#include <string.h>
...
void HandleIdentify() {
  ...
  response.board_id = JW1_BOARD_ARDUINO_UNO;
