// firmware/esp32 — Joshua's own firmware protocol (joshua_wire_v1) on an
// ESP32, driving TB6600 (or any STEP/DIR drive) channels declared in
...
//
// Identical to firmware/teensy/41/src/main.cpp except HandleIdentify()'s
// board_id — everything else here is plain Arduino-framework code, not
// ESP32- or Teensy-specific (docs/BOARD_LAYER_RFC.md §7.3 ④).
#include <Arduino.h>
#include <string.h>
...
void HandleIdentify() {
  ...
  response.board_id = JW1_BOARD_ESP32;
