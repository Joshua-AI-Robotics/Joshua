...
EXAMPLE="$SDK/examples/industrial_comms/ethercat_slave_demo/device_profiles/401_simple/am243x-lp/r5fss0-0_freertos/ti-arm-clang"

CCS_PATH="${CCS_PATH:-$HOME/ti/ccs2100/ccs}"
SYSCFG_PATH="${SYSCFG_PATH:-$HOME/ti/sysconfig_1.17.0}"
ARM_CLANG_PATH="${CGT_TI_ARM_CLANG_PATH:-$HOME/ti/ccs2100/ccs/tools/compiler/ti-cgt-armllvm_5.1.1.LTS}"
