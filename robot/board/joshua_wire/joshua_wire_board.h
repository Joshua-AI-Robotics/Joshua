...
// Joshua-firmware MCU board (TeensyBoard and ArduinoBoard today; a future
...
// channels, so ValidateComm/CreateTransport below default to SERIAL.
// ArduinoBoard overrides CreateTransport only to wait out the Uno DTR
