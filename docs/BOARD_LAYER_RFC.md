...
`FrameTransport` seam, new AVR firmware image) — host/firmware source is
written; flashing and physical rotation on a real Uno R3 are still open.
An **ESP32** board is a candidate third matrix
