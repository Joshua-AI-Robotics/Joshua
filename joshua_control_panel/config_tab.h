...
class ConfigTab : public QWidget {
 ...
 private:
  ...
  struct OneofNode {
    ...
    std::vector<std::unique_ptr<MessageNode>>
        choiceNodes;  // same indices as choiceFields (1..N) mapped to 1..N
  ...
  // UI construction
  void buildRootForm();
  std::unique_ptr<MessageNode> buildMessageNode(const google::protobuf::Descriptor* descriptor,
  ...
  std::unique_ptr<MessageNode> buildSingleMessageField(
      const google::protobuf::FieldDescriptor* field);
  RepeatedMessageFieldNode buildRepeatedMessageField(
      const google::protobuf::FieldDescriptor* field);
  // New helpers for repeated primitives
  RepeatedPrimitiveFieldNode buildRepeatedPrimitiveField(
      const google::protobuf::FieldDescriptor* field);
  QWidget* buildPrimitiveEditor(const google::protobuf::FieldDescriptor* field);
  void addRepeatedPrimitiveRow(RepeatedPrimitiveFieldNode* node,
                               const QVariant& initial = QVariant());
  ...
  void writeRepeatedMessageField(const RepeatedMessageFieldNode& node,
                                 google::protobuf::Message* message);
  // New: write repeated primitive fields
  void writeRepeatedPrimitiveField(const RepeatedPrimitiveFieldNode& node,
                                   google::protobuf::Message* message);
  ...
  void readRepeatedMessageFieldIntoChildren(const google::protobuf::Message& message,
                                            RepeatedMessageFieldNode* node);
  // New: read repeated primitive fields
  void readRepeatedPrimitiveFieldIntoEditors(const google::protobuf::Message& message,
